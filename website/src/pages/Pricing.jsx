    ...
    const plans = [
        {
            ...
            features: [
                { name: 'Basic returns processing', included: true },
                { name: 'Activity logs (read-only)', included: true },
                { name: 'Local storage', included: true },
                { name: 'Manual backup', included: true },
                { name: 'Packing camera', included: false },
                { name: 'Analytics dashboard', included: false },
                { name: 'Multi-staff support', included: false },
                { name: 'Auto backup', included: false },
            ],
        },
        {
            name: 'Pro',
            ...
            features: [
                ...
                { name: 'Packing camera with video evidence', included: true },
                { name: 'Analytics dashboard', included: true },
                { name: 'Multi-staff support', included: true },
                { name: 'Inventory reconciliation', included: true },
                { name: 'Evidence export (PDF)', included: true },
                { name: 'Auto backup', included: true },
